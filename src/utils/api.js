...
const getAllCryptocurrencies = () => {
  const { REACT_APP_COINMARKETCAP_API_KEY: COINMARKETCAP_API_KEY } = process.env
...
const loginAPI = (email, password) => {
  const { REACT_APP_COININFO_API_URL: COININFO_API_URL, NODE_ENV } = process.env
...
export { getAllCryptocurrencies, getAllNews, loginAPI, isLoginedAPI, logoutAPI, registrationAPI }
